...
// Get charging points if station is selected
$chargingPoints = $stationId ? getStationChargingPoints($stationId) : [];
            ...
            <div class="card-body">
                <form id="booking-form" method="POST" action="process-booking.php" class="needs-validation">
                    ...
                    <div class="form-group">
                        ...
                        <select id="charging-point-id" name="charging_point_id" class="form-control form-select" required <?= empty($chargingPoints) ? 'disabled' : '' ?>>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Station select onchange -> redirect
        const stationSelect = document.getElementById('station-id');
        stationSelect.addEventListener('change', function () {
            const selected = this.value;
            if (selected) {
                window.location.href = '?station_id=' + selected;
            }
        });
    });
</script>
